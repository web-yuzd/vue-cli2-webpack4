...
<template>
  <div class="layout">
    <i-layout>
      <i-sider ref="side1" hide-trigger collapsible :collapsed-width="78" v-model="isCollapsed">
      ...
      <i-layout>
        <i-header :style="{padding: 0}" class="layout-header-bar">
          <i-icon @click.native="collapsedSider" :class="rotateIcon" :style="{margin: '0 20px'}" type="md-menu" size="24"></i-icon>
        </i-header>
